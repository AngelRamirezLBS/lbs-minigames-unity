...
{
    public sealed class ObjectSelectionGame : MonoBehaviour, IAppScene, ILevelTransitionParticipant
    {
        ...
        [SerializeField] private Sprite backgroundArtwork, tenisArtwork, sombreroArtwork, gorroArtwork, gorraArtwork;
        ...
        private void Build()
        {
            ...
            board = new GameObject("ObjectSelectionBoard", typeof(RectTransform)).GetComponent<RectTransform>();
            ...
            CreateAnswer("tenis", tenisArtwork, new Vector2(700, 350));
            CreateAnswer("gorra", gorraArtwork, new Vector2(1220, 350));
            CreateAnswer("sombrero", sombreroArtwork, new Vector2(700, 750));
            CreateAnswer("gorro", gorroArtwork, new Vector2(1220, 750));
            EnsureScoreFont();
        }
        ...
        private void Select(string id, RoundedSurface surface)
        {
            ...
            bool correct = state.Select(id, ObjectSelectionRule.CorrectAnswer);
        ...
        private void CreateFinal()
        {
            ...
            services?.GameLauncher.Complete(new MiniGameResult("object.selection", MiniGameCompletionState.Completed, state.Score, 1, 1, services.Session.SelectedDifficultyId));
        }
